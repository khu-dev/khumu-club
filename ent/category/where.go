...
func HasClubs() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ClubsTable, ClubFieldID),
...
func HasClubsWith(preds ...predicate.Club) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ClubsInverseTable, ClubFieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, ClubsTable, ClubsPrimaryKey...),
		)
